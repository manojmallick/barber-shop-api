...
public class RestErrorHandlerTest {
  ...
  @InjectMocks GenericExceptionHandler restErrorHandler;
  ...
  public void handleNoHandlerFoundException() {
    ...
    ResponseEntity<Object> responseEntity =
        restErrorHandler.handleNoHandlerFoundException(
  ...
  public void handleIllegalArgumentException() {
    ...
    ResponseEntity<Object> responseEntity =
        restErrorHandler.handleIllegalArgumentException(exception);
    assertNotNull(responseEntity);
    assertThat(responseEntity.getStatusCode(), is(HttpStatus.BAD_REQUEST));
  }
  ...
  public void handleResourceAlreadyExists() {
    ResourceAlreadyExists exception =
        new ResourceAlreadyExists(
            "mapping failed", ErrorCodes.ERROR_DUPLICATE_BOOKING_BARBER, null);
  ...
  public void handleResourceNotFoundException() {
    ...
    ResponseEntity<Object> responseEntity =
        restErrorHandler.handleResourceNotFoundException(exception);
    assertNotNull(responseEntity);
  ...
  public void handleMethodArgumentTypeMismatch() {
    MethodArgumentTypeMismatchException exception =
        new MethodArgumentTypeMismatchException("name", null, null, null, null);
    ResponseEntity<Object> responseEntity =
        restErrorHandler.handleMethodArgumentTypeMismatch(exception, null);
    assertNotNull(responseEntity);
    assertThat(responseEntity.getStatusCode(), is(HttpStatus.BAD_REQUEST));
  }
  ...
  public void handleHttpMessageNotReadable() {
    ...
    HttpMessageNotReadableException exception =
        new HttpMessageNotReadableException(null, null, null);
    ResponseEntity<Object> responseEntity =
  ...
  public void handleHttpMediaTypeNotSupported() {
    ...
    HttpMediaTypeNotSupportedException exception =
        new HttpMediaTypeNotSupportedException(MediaType.ALL_VALUE);
    ResponseEntity<Object> responseEntity =
