...
public class GenericExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
    ...
    ApiError err =
        new ApiError(
            LocalDateTime.now(),
            ErrorCodes.ERROR_UNKNOWN_MEDIA_TYPE.getCode(),
  ...
  protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(
      MethodArgumentTypeMismatchException typeMismatchException, WebRequest request) {
    List<String> details = new ArrayList<String>();
    ...
    ApiError err =
        new ApiError(
            LocalDateTime.now(),
            ErrorCodes.ERROR_TYPE_MISMATCH.getCode(),
            typeMismatchException.getClass().getSimpleName(),
            HttpStatus.BAD_REQUEST,
            "Mismatch Type",
            details);
  ...
  public ResponseEntity<Object> handleResourceNotFoundException(
    ...
    ApiError err =
        new ApiError(
            LocalDateTime.now(),
            ErrorCodes.ERROR_NOT_FOUND.getCode(),
            resourceNotFoundException.getClass().getSimpleName(),
  ...
  public ResponseEntity<Object> handleResourceAlreadyExists(
    ...
    ApiError err =
        new ApiError(
            ...
            resourceAlreadyExists.getClass().getSimpleName(),
            HttpStatus.CONFLICT,
            "Resource exists",
            details);
  ...
  public ResponseEntity<Object> handleIllegalArgumentException(
    ...
    ApiError err =
        new ApiError(
            LocalDateTime.now(),
            ErrorCodes.GENERIC_ERROR_BAD_REQUEST.getCode(),
  ...
  public ResponseEntity<Object> handleMappingException(MappingException mappingException) {
    ...
    ApiError err =
        new ApiError(
            LocalDateTime.now(),
            ErrorCodes.ERROR_RESOURCE_EXIST.getCode(),
  ...
  protected ResponseEntity<Object> handleNoHandlerFoundException(
    ...
    ApiError err =
        new ApiError(
            LocalDateTime.now(),
            ErrorCodes.ERROR_NO_HANDLER.getCode(),
            noHandlerFoundException.getClass().getSimpleName(),
            HttpStatus.BAD_REQUEST,
            "Method Not Found",
            details);
  ...
  public ResponseEntity<Object> handleGenericApiException(
      GenericApiException genericApiException, WebRequest request) {
    ...
    ApiError err =
        new ApiError(
            LocalDateTime.now(),
            genericApiException.getErrorCodes().getCode(),
            genericApiException.getClass().getSimpleName(),
            genericApiException.getHttpStatus(),
