...
public class AvailabilityService {
   ...
   */
  public List<Availability> getAllAvailabilityByDate(final LocalDate bookingDate,
    ...
    dateSlots.stream().forEach(
        dateSlot -> {
          Set<String> finalTimeslots = barberShopApiUtil
              .getTimeSlots(simpleDateFormat, shop, dateSlot);
  ...
  private void removeTimeSlotsIfBooked(List<Barber> barbers, Set<String> finalTimeslots,
